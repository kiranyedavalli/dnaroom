 ...
 */
var createOffer = exports.createOffer = (0, _curry3.default)(function (pc, offerOptions, bandwithLimit) {
  ...
  return pc.createOffer(offerOptions).then((0, _common.tap)(function (offer) {
    offer.sdp = limitBandwith(bandwithLimit, offer.sdp);
  ...
  .then(function () {
    return limitBandwith(bandwithLimit, pc.localDescription.sdp);
  });
});
